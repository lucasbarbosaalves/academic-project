...
import com.github.lucasbarbosaalves.hotelmanagement.dto.RoomDTO;
...
import com.github.lucasbarbosaalves.hotelmanagement.service.AwsS3Service;
...
public class RoomServiceImpl implements RoomService {
    ...
    public RoomServiceImpl(RoomRepository roomRepository, BookingRepository bookingRepository, AwsS3Service awsS3Service) {
    ...
    public Response deleteRoom(Long roomId) {
        ...
        try {
            roomRepository.findById(roomId).orElseThrow(() -> new DomainException("Room Not Found"));
    ...
    public Response updateRoom(Long roomId, String description, String roomType, BigDecimal roomPrice, MultipartFile photo) {
        ...
        try {
            ...
            Room room = roomRepository.findById(roomId).orElseThrow(() -> new DomainException("Room Not Found"));
