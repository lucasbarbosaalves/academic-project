    ...
    <div className="room-details-booking">
      {showMessage && (
        <p className="booking-success-message">
          Reserva feita com sucesso! Código de confirmação: {confirmationCode}. Foram enviados um SMS e email com detalhes de sua reserva!
        </p>
      )}
      {errorMessage && (
      ...
      <div className="room-details-info">
        <h3>{roomType}</h3>
        <p>Preço: ${roomPrice} / pernoite</p>
        <p>{description}</p>
      </div>
      {bookings && bookings.length > 0 && (
        <div>
          <h3>Detalhes da reserva atual</h3>
      ...
      <div className="booking-info">
        <button className="book-now-button" onClick={() => setShowDatePicker(true)}>Reserva agora</button>
        ...
        {showDatePicker && (
          <div className="date-picker-container">
            ...
            <div className='guest-container'>
              ...
              <button className="confirm-booking" onClick={handleConfirmBooking}>Confirme sua reserva</button>
            </div>
          </div>
        )}
        {totalPrice > 0 && (
          <div className="total-price">
            ...
            <button onClick={acceptBooking} className="accept-booking">Continuar</button>
          </div>
        )}
      </div>
    </div>
